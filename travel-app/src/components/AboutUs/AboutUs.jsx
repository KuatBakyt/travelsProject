...
import SliderTour from '../Slider/Slider';
  ...
  return (
    <div>
      <div className='about-us'>
        ...
        <div className='ao-sectiontwo-3'>
          <div className='ao-wrapperthree'>
            <div className='ao-leaf2'>
                  <img src='./img/ao-leaf2.png'/>
              </div>
            <div className='ao-img-oiu'>
              <div className='ao-img-oiu-12'>
                  <img src='./img/ao-oiu1.png'/>
              </div>
              <div>
                  <img src='./img/ao-oiu1.png'/>
